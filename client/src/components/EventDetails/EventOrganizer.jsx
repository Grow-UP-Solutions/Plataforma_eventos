      ...
      <div className={styles.container}>
       ...
       <div className={styles.orgCont}>
          ...
          <div  className={styles.orgSubCont}>
            ...
            <p className={styles.orgMembership}>Miembro desde {event.organizer.membership}</p>
          </div>
        </div>
        <p className={styles.orgDescription}>{event.organizer.descriptionOrganizer}</p>
        <button className={styles.button2} >Otros eventos organizados por {event.organizer.name}</button>
