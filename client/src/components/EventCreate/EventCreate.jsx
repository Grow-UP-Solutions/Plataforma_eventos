    ...
    <div className={styles.containerall} >
      ...
      <div className={styles.container}>
        ...
        <div className={styles.items}>
          ...
          <p className={styles.subTitle}>Puedes controlar los precios, cantidad de asistentes, fechas y horas de tus eventos. Tú pones las reglas.</p>
        </div>
        <div className={styles.items}>
          <img className={styles.img}  src={icon3} alt='n'/>
          <p className={styles.title}>Control</p>
          <p className={styles.subTitle}> Estas en control total de tus finanzas a través de las herramientas digitales disponibles en tu perfil. </p>
        </div>
        <div className={styles.items}>
        ...
        <div className={styles.items}>
          ...
          <p className={styles.subTitle}>Cuentas con nuestro apoyo en cada paso de tu publicación. </p>
        </div>
        <div className={styles.items}>
          <img className={styles.img} src={icon6} alt='n'/>
          <p className={styles.title}>Guía</p>
          <p className={styles.subTitle}>Cuentas con guías del organizador para ayudarte a crear un evento exitoso y popular que maximice tus ingresos</p>
        </div>
      </div>
    </div>
 )
