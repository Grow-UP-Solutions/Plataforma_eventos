...
import styles from './MessagesResponsive.module.css';
...
const MessagesResponsive = () => {
  ...
  const [isSelectConversation, setIsSelectConversation] = useState(false);
    ...
    return (
      <div className={`${styles.pageMessage}`}>
        {isSelectConversation && (
          <div className={styles.containerReturnConversation}>
            <IoIosArrowBack onClick={() => setIsSelectConversation(false)} className={styles.iconReturn} />
          </div>
        )}
            ...
            <div>
              ...
              <div className={styles.containerInputMessage}>
                ...
                <div className={styles.wrapperBtnInputMessage}>
                  <p>
                    No se permite el envío de números de teléfono, direcciones de correo electrónico, enlaces a sitios
                    web o enlaces a redes sociales.
                  </p>
                  {currentChat === null ? (
...
export default MessagesResponsive;
